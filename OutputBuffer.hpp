...
public:
  ...
  OutputBuffer(void* argBuf,size_t argBufSize,bool argIsInitial=false):buf((uint8_t*)argBuf),bufSize(argBufSize),pos(0),bufMode(argIsInitial?bmExternalInitial:bmExternalFixed)
  {
